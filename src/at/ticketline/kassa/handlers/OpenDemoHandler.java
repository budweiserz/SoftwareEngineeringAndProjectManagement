...
public class OpenDemoHandler {

    private static final Logger LOG = LoggerFactory.getLogger(OpenDemoHandler.class);
    ...
    private void openPart(MApplication application,
        ...
        MPart part = partService.createPart("at.ticketline.partdescriptor.newdemo");
        
        // Allgemeine Einstellungen des Parts
        part.setLabel("Neue Demo");
        part.setTooltip("Neue Demo anlegen");
        ...
        try {
            ...
            LOG.error("Part fuer neue Demo konnte nicht geoeffnet werden: {}", e.getMessage());
        }
    }
}