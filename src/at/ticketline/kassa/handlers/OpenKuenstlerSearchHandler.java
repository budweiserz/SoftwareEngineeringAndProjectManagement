...
public class OpenKuenstlerSearchHandler {

    private static final Logger LOG = LoggerFactory.getLogger(OpenKuenstlerSearchHandler.class);
    ...
    private void openPart(MApplication application,
        ...
        MPart part = partService.createPart("at.ticketline.partdescriptor.searchKuenstler");
        
        // Allgemeine Einstellungen des Parts
        part.setLabel("Suche Künstler");
        part.setTooltip("Eine Suche für einen Künstler starten");
        ...
        try {
            ...
            LOG.error("Part fuer Künstlersuche konnte nicht geoeffnet werden: {}", e.getMessage());
        }
    }
}