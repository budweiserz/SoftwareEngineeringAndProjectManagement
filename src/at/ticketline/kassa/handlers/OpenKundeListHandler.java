...
public class OpenKundeListHandler {
    ...
    private void openPart(MApplication application, EModelService modelService, EPartService partService, IEclipseContext context) throws ExecutionException {
        ...
        MPart part = partService.createPart("at.ticketline.partdescriptor.listkunde");
        
        // Allgemeine Einstellungen des Parts
        part.setLabel("Kundenliste");
        //part.setTooltip("Kundenliste anzeigen");
        ...
        try {
            ...
            LOG.error("Part fuer Kundenliste konnte nicht geoeffnet werden: {}", e.getMessage());
        }
    }
}
